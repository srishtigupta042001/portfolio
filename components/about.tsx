          ...
          <div className="md:col-span-2">
            <div className="bg-navy/50 backdrop-blur-sm p-6 rounded-lg border border-purple/20 shadow-xl">
              <p className="text-lg leading-relaxed mb-6">
                I am a passionate Software Developer with expertise in Python, React.js, Node.js, and API development. I specialize in building scalable applications, managing databases, and optimizing workflows. My experience includes Zoho integrations, REST APIs, and front-end development.
              </p>
              <p className="text-lg leading-relaxed">
                I thrive on delivering high-performance software solutions and continuously enhancing my skills in Full Stack Development (MERN) and Python. With strong problem-solving abilities, I excel in fast-paced environments, tackling challenges with efficiency and innovation.
              </p>
            </div>
