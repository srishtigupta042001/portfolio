      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl">
            Motivated Software Developer with expertise in Python, React.js, Node.js, and API development. Passionate
            about delivering efficient and high-performance software solutions.
          </p>
